...
class Zikribayanay extends StatefulWidget {
  const Zikribayanay({super.key});

  @override
  State<Zikribayanay> createState() => _ZikribayanayState();
}

class _ZikribayanayState extends State<Zikribayanay> {
  ...
  Future<void> _toggleSound() async {
    if (_isPlaying) {
      ...
      await _player.play(AssetSource("sounds/sbah.mp3"));
    }
    setState(() {
