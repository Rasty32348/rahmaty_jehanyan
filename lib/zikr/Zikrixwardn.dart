...
class Zikrixwardn extends StatefulWidget {
  const Zikrixwardn({super.key});

  @override
  State<Zikrixwardn> createState() => _ZikribayanayState();
}

class _ZikribayanayState extends State<Zikrixwardn> {
  ...
  Future<void> _toggleSound() async {
    if (_isPlaying) {
      ...
      await _player.play(AssetSource("sounds/xwardn.mp3"));
    }
    setState(() {
            ...
            IconButton(
              ...
              const SizedBox(height: 16),
               ...
               Card(
                child: Padding(
                  ...
                  child: const Text(
                    "زیکری پێش خواردن و خواردنەوە\n"
                    "بِسْمِ اللهِ.\n"
                    "زیکردی خواردن و خواردنەوە کاتێک لەسەرەتاوە بیرێت چوو\n"
              ...
              const SizedBox(height: 8),
                ...
                child: Padding(
                  padding: const EdgeInsets.all(12),
                  child: const Text(
                    "زیکری دوای تەواوبوونی خواردن و خواردنەوە\n"
